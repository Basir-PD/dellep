...
export const CardTitle = ({
  ...
  return (
    <h3 className={cn("text-lg font-semibold text-neutral-900 dark:text-white py-2", className)}>
      {children}
    </h3>
  );
};
  ...
  return (
    <div
      className={cn(
        ...
        className,
        showGradient &&
          "bg-neutral-100 dark:bg-[rgba(40,40,40,0.30)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
